...
def simple_loop():
	...
	while True:
		...
		mean_price = last_price['open'].iloc[0:5].mean()
		# retrieve the very last quote to compare with
		actual_price = last_price['open'].iloc[0].mean()
...
if __name__ == '__main__':
	...
	portfolio_overview()
	stock_list_simple = ['AAPL', 'TSLA', 'GOOG', 'NVDA']
	simple_loop(equities_list=stock_list_simple)
