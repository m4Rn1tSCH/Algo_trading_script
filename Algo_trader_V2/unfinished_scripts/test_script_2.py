...
timespan="minute", symbol=symbol, limit=1000, _from='2019-01-01', to='2021-01-26', multiplier=1
).df
c += 1
...
#I had to import from alpaca_trade_api.polygon.rest import 
#FinancialsReportType, FinancialsSort and rather than using a
#string input for the report_type and sort as expected,
#I had ot use FinancialReportType and FinancialsSort.
import alpaca_trade_api as tradeapi
